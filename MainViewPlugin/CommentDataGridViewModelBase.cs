...
//    /// </summary>
//    [Obsolete("Baseクラスとして継承させる形ではなく、ViewModelにプロパティとしてCommentDataGridViewModelを持たせたい")]
...
//        public CommentDataGridViewModelBase(IAdapter options)
//        {
//            _options = options;
...
//        }
//        public CommentDataGridViewModelBase(Adapter options, ICollectionView comments)
//        {
//            _options = options;
//            Comments = comments;
//            _dispatcher = Dispatcher.CurrentDispatcher;
